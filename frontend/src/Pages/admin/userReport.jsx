...
const UserReportsPage = () => {
    ...
    const downloadPDF = async () => {
        ...
        try {
            ...
            logo.src = "/logo123.png"; // public path (no /public prefix)
        ...
        // Add Report Title
        doc.setFontSize(16);
        doc.text("Mihisara Grocery Inventory & Supply Cost Analysis", pageWidth / 2, 40, { align: "center" });
